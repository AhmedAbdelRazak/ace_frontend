			...
			if (data.error) {
				...
				if (selectedFilter === "SelectAll") {
					...
					setAllOrders(
						data
							.filter(
								(i) => i.status === "In Processing" && i.orderSource === "ace",
							)
							.sort(sortOrdersAscendingly),
					);
					setExcelDataSet(
					...
					setAllOrders(
						data
							.filter((i) => i.status === "On Hold" && i.orderSource === "ace")
							.sort(sortOrdersAscendingly),
					);
					setExcelDataSet(
						data
					...
					setAllOrders(
						data
							.filter((i) => i.status === "Shipped" && i.orderSource === "ace")
							.sort(sortOrdersAscendingly),
					);
					setExcelDataSet(
						data
					...
					setAllOrders(
						data
							.filter(
								(i) => i.status === "Delivered" && i.orderSource === "ace",
							)
							.sort(sortOrdersAscendingly),
					);
					setExcelDataSet(
					...
					setAllOrders(
						data
							.filter(
								(i) => i.status === "Cancelled" && i.orderSource === "ace",
							)
							.sort(sortOrdersAscendingly),
					);
					setExcelDataSet(
					...
					setAllOrders(
						data
							.filter(
								(i) =>
									i.invoiceNumber === "Not Added" && i.orderSource === "ace",
							)
							.sort(sortOrdersAscendingly),
					);
					setExcelDataSet(
	...
	const loadOrdersFiltered = () => {
		listOfOrdersFiltered(user._id, token, 20).then((data) => {
			if (data.error) {
				...
				setAllOrdersFiltered(data.filter((i) => i.orderSource === "ace"));
			}
		});
	};
